    ...
    <div className="animate-in fade-in slide-in-from-bottom-6 mx-auto flex w-full max-w-[1400px] flex-col gap-8 p-6 duration-700 lg:p-10">
              ...
              <div className="absolute inset-0 z-10 flex flex-col bg-[#F4F6F9]">
                ...
                <div className="flex-1 space-y-4 overflow-hidden p-5">
                  <div className="rounded-2xl border border-ink-100 bg-white p-4 shadow-sm">
                    ...
                    <div className="mb-2 h-3 w-full rounded-full bg-ink-100" />
                    <div className="mb-4 h-3 w-3/4 rounded-full bg-ink-100" />
                    <div className="flex gap-2">
                      <div className="h-8 flex-1 rounded-lg border border-ink-200 bg-ink-50" />
                      <div className="h-8 flex-1 rounded-lg border border-ink-200 bg-ink-50" />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 rounded-2xl border border-ink-100 bg-white p-4 shadow-sm">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border-4 border-emerald-400 text-xs font-semibold text-ink-700">
                      80%
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-ink-800">Meta de questões</p>
                      <p className="text-[9px] font-bold text-ink-400">80/100 resolvidas hoje</p>
                    </div>
                  </div>
                </div>
      ...
      <div className="relative flex flex-col items-center justify-between gap-10 overflow-hidden rounded-[2.5rem] border border-ink-100 bg-white p-8 shadow-sm md:flex-row lg:p-12">
        ...
        <div className="relative z-10 flex-1 text-center md:text-left">
          ...
          <p className="max-w-xl text-lg font-medium leading-relaxed text-ink-500">
        ...
        <div className="relative z-10 shrink-0 rounded-[2rem] border border-ink-200 bg-gradient-to-br from-ink-50 to-white p-5 shadow-sm">
          <div className="relative flex h-44 w-44 items-center justify-center rounded-2xl border border-ink-100 bg-white shadow-sm">
          ...
          <p className="mt-3 text-center text-[10px] font-semibold uppercase tracking-widest text-ink-400">
...
function FeatureCard({ icon: Icon, iconClass, title, text }) {
  return (
    <div className="group flex flex-col items-start rounded-[2rem] border border-ink-100 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:border-blue-300 hover:shadow-md">
      ...
      <h4 className="mb-3 text-xl font-semibold tracking-tight text-ink-800">{title}</h4>
      <p className="text-sm font-medium leading-relaxed text-ink-500">{text}</p>
    </div>
  );
}
