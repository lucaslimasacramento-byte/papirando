...
import { Eye, EyeOff, Loader2, AlertCircle, CheckCircle2, Smartphone, Stars } from 'lucide-react';
...
export default function Login({
  ...
  const resetForm = () => {
    setNome(''); setCelular(''); setEmail(''); setPassword('');
    setConfirmPassword(''); setConcurso('');
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <p style={{
            ...
            A plataforma de estudos pra concurso que fala a sua língua. Marca a página,
            papira a questão, volta de onde parou.
          </p>
        </div>
      ...
      <div style={{
        ...
        <p style={{
          ...
          {isLoginMode
            ? 'Que bom te ver papirando de novo. Sua sequência tá esperando você lá dentro.'
            : 'Conta grátis. Plano de estudos personalizado em 2 minutos — a gente pergunta o concurso-alvo e cuida do resto.'}
        </p>
          ...
          >
            ...
            {!isLoginMode && (
              <span style={{ fontSize: 11.5, color: 'var(--pl-ink-3)', fontWeight: 500 }}>
                Mínimo 6 caracteres. Mistura letras e números, pelo menos.
              </span>
            )}
          </PlField>
        ...
        <div style={{
          ...
          {isLoginMode ? (
            ...
            <>
              ...
              <br /><br />
              Criar conta significa que você topa nossos{' '}
