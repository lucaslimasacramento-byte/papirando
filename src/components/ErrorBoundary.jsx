    ...
    if (this.state.hasError) {
      return (
        <div className="flex min-h-screen items-center justify-center bg-ink-100 px-4">
          <div className="w-full max-w-md rounded-xl border border-ink-200/90 bg-white p-8 text-center shadow-sm">
            <p className="text-3xl" aria-hidden>
              —
            </p>
            <h2 className="mt-4 text-lg font-semibold tracking-tight text-ink-900">Algo saiu do esperado</h2>
