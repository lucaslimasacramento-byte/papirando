    ...
    <div className="fixed inset-0 z-[1000] bg-[#1e40af]/80 backdrop-blur-md animate-in fade-in duration-300 flex items-center justify-center p-4">
      <div className="bg-white rounded-[3rem] shadow-2xl w-full max-w-5xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-500 max-h-[95vh]">
        <div className="px-10 py-8 flex justify-between items-center bg-white border-b border-ink-100 relative">
          ...
          <button onClick={() => setIsCadernoModalOpen(false)} className="text-ink-400 hover:text-red-500 transition-colors p-3 rounded-2xl hover:bg-red-50">
        ...
        <div className="flex-1 overflow-y-auto p-10 custom-scrollbar space-y-8 bg-[#F4F6F9]/30">
          ...
          <div className="bg-white p-6 rounded-[2rem] border border-ink-200 shadow-sm">
            <label className="block text-[11px] font-black text-ink-400 uppercase tracking-widest mb-4">Opções avançadas</label>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label className="flex items-center gap-3 cursor-pointer group p-3 rounded-xl hover:bg-ink-50 transition-colors border border-transparent hover:border-ink-200">
                <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-2 border-ink-300 text-[#1d4ed8] focus:ring-[#1d4ed8] cursor-pointer" />
                <span className="text-sm font-bold text-ink-600 group-hover:text-[#1d4ed8] transition-colors">Excluir questões anuladas/desatualizadas</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group p-3 rounded-xl hover:bg-ink-50 transition-colors border border-transparent hover:border-ink-200">
                <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-2 border-ink-300 text-[#1d4ed8] focus:ring-[#1d4ed8] cursor-pointer" />
                <span className="text-sm font-bold text-ink-600 group-hover:text-[#1d4ed8] transition-colors">Apenas questões com comentários</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group p-3 rounded-xl hover:bg-ink-50 transition-colors border border-transparent hover:border-ink-200">
                <input type="checkbox" className="w-5 h-5 rounded border-2 border-ink-300 text-[#1d4ed8] focus:ring-[#1d4ed8] cursor-pointer" />
                <span className="text-sm font-bold text-ink-600 group-hover:text-[#1d4ed8] transition-colors">Esconder questões que já resolvi</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group p-3 rounded-xl hover:bg-ink-50 transition-colors border border-transparent hover:border-ink-200">
                <input type="checkbox" className="w-5 h-5 rounded border-2 border-ink-300 text-[#1d4ed8] focus:ring-[#1d4ed8] cursor-pointer" />
                <span className="text-sm font-bold text-ink-600 group-hover:text-[#1d4ed8] transition-colors">Apenas questões inéditas do Papirando</span>
              </label>
            </div>
          </div>
        </div>
