       ...
       <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg p-6 md:p-8 relative animate-in zoom-in-95 duration-300">
          ...
          <div className="flex gap-4 items-end mb-8 border border-transparent hover:border-gray-100 p-2 -mx-2 rounded-xl transition-colors">
             ...
             <div className="flex-1">
                ...
                <input type="text" className="w-full border-b-2 border-[#1d4ed8] outline-none py-1.5 text-gray-800 font-semibold focus:border-[#1d4ed8] transition-colors bg-transparent" placeholder="Ex: Aula de Constitucional" />
             </div>
             <div className="flex-1">
                <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1">Link</label>
                <input type="text" className="w-full border-b-2 border-[#1d4ed8] outline-none py-1.5 text-gray-800 font-semibold focus:border-[#1d4ed8] transition-colors bg-transparent" placeholder="https://..." />
             </div>
