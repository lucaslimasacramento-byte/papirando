...
export default function App() {
    ...
    await saveContestTemplate(
      {
        ...
        catalog_batch: templateData.catalog_batch || null,
  ...
  const importSelectedEditalWithAI = async ({
    ...
    // Juntando a um curso existente, o curso e ele mesmo: criar outro daria dois planos com
    // a mesma materia e o progresso dividido, que e justamente o que "Onde entra este
    // edital?" evita.
